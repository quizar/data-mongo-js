...
quizItem.add('property.values[].value', 'values[].value');
quizItem.add('property.values[].qualifiers[].id', 'values[].qualifiers[].id');
quizItem.add('property.values[].qualifiers[].type', 'values[].qualifiers[].type');
quizItem.add('property.values[].qualifiers[].value', 'values[].qualifiers[].value');
