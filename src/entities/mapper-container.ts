...
quizItem.add('propertyId');
quizItem.add('value.type', 'valueType');
quizItem.add('value.value', 'value');
// quizItem.add('value.entity.id', 'valueEntityId');
